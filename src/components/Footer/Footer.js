    ...
    return (
        <footer className="footer">
            ...
            <div className="footer__contact">
                <h3 className="footer-title">Diseñado por Julián Draco</h3>
                <ul className='contact__icons'>
                    <li><a href='' target='_blank' rel='noreferrer'><FacebookOutlinedIcon/></a></li>
                    <li><a href='' target='_blank' rel='noreferrer'><EmailIcon/></a></li>
                    <li><a href='' target='_blank' rel='noreferrer'><GitHubIcon/></a></li>
                    <li><a href='' target='_blank' rel='noreferrer'><LinkedInIcon/></a></li>
                </ul>
            </div>
